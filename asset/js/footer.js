    ...
    if (normal) {
        var content = `
            <div class="container text-center py-3 small border-top" style="margin-top: 100px;">
                ...
                <p class="text-center">This project is not directly managed by or affiliated with <a href="https://www.gd.edu.kg/" target="_blank">GitData</a>, although it utilizes a subdomain of gd.edu.kg.</p>
